...
@extends('library.default2')

@section('title', "IssueBook")

@section('content')
@section('title2', "Issue Return")
...
<form class="max-w-md mx-auto" action="" method="post">
    ...
    <div class="relative z-0 w-full mb-5 group">
      <input type="text" name="name" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-heading bg-transparent border-0 border-b-2 border-default-medium appearance-none focus:outline-none focus:ring-0 focus:border-brand peer" placeholder=" " required />
